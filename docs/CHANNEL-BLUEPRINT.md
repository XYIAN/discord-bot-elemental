# Channel Blueprint (Legend of Elements)

This is the starter channel taxonomy for the new server. It mirrors the proven architecture pattern while staying game-specific.
...
Points should be awarded in public strategy channels only (unless you explicitly decide to include private clan channels later).

The starter config currently awards points by channel name for:
